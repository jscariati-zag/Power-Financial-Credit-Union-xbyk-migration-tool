...
{
    class PageConverterSection : IPageConverter
    {
        public string Type => "custom.Section";
        public string TargetType => "Custom.Page_Section"; //none
        private readonly IConfiguration _config;
        private readonly FieldConverters _fieldConverters;

        public PageConverterSection(IConfiguration config, FieldConverters fieldConverters)
        {
            _config = config;
