...
{
    class PageConverterMegaMenuHeading : IPageConverter
    {
        public string Type => "custom.MegaMenuHeading";
        public string TargetType => "Custom.Page_MegaMenuHeading"; //none
        private readonly IConfiguration _config;
        private readonly FieldConverters _fieldConverters;

        public PageConverterMegaMenuHeading(IConfiguration config, FieldConverters fieldConverters)
        {
            _config = config;
