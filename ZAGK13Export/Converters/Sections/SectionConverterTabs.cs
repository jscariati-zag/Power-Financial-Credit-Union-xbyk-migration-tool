...
//{
//    class SectionConverterTabs : ISectionConverter
//    {
//        public string Type => "custom.PartialTabs";
//        public string TargetType => "Custom.Components.Sections.Tabs";
...
//        public SectionConverterTabs(IConfiguration config, FieldConverters fieldConverters, WidgetService widgetService, IEnumerable<IWidgetConverter> widgetConverters)
//        {
//            _config = config;
...
//                    {
//                        identifier = Guid.NewGuid().ToString(),
//                        name = "Section_" + sectionGuid + "_Tabs_" + panelGuid + "_Panel",
//                        widgets = widgets
//                    });
