...
{
    class WidgetConverterFeatures : IWidgetConverter
    {
        public string Type => "custom.PartialFeatures";
        public string TargetType => "Custom.Components.Widgets.Features";
        private readonly FieldConverters _fieldConverters;

        public WidgetConverterFeatures(FieldConverters fieldConverters)
        {
